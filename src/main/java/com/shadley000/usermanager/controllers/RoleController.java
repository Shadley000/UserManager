...
public class RoleController {
    ...
    public static final String SQL_GET_ROLE_BY_APPLICATION_USER = SQL_GET_ROLE + ", role_to_users j WHERE r.application_id = ? AND j.users_id = ?";
    public static final String SQL_GET_ROLE_BY_USER = SQL_GET_ROLE + ", role_to_users j WHERE j.users_id = ?";
